...
:small_orange_diamond: La mise en place de la convergence des luttes des différentes idéologies de gauche, notamment en nous enrichissant mutuellement de nos analyses et de nos savoirs, et en développant des liens affectifs entre individus d'idéologie différente.
.
```
```
...
:small_orange_diamond:**__Agora__**: L'ensembles de salons disponibles pour les personnes qui ne sont pas encore admises.
